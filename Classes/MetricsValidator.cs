...
namespace Classes
{
    public class MetricsValidator
    {
        ...
        {
            var validatedMetrics = metric.Split(':');
            ...
            var validatedMetricName = ValidateMetricName(validatedMetrics[0]);
            ...
            var validatedMetricValue = ValidateMetricValue(validatedMetrics[1]);
        ...
        {
            if (string.IsNullOrEmpty(metricValue)) return null;
        ...
        {
            var sb = new StringBuilder(Errors.ValidationError);
            sb.Append(" ");
            sb.Append(metric);
